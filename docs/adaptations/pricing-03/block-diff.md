# Adaptation Diff: pricing.original.tsx → Signet Hero
...
-          {/* Starter */}
-          <div className="p-8 rounded-xl border border-gray-800 bg-gray-900 flex flex-col items-center text-center transition-transform hover:scale-105">
-            <h3 className="text-xl mb-4">Starter</h3>
-            <div className="text-4xl font-bold mb-6">$19</div>
-            <ul className="text-sm text-gray-400 space-y-4 mb-8 flex-1">
...
-          {/* Pro */}
-          <div className="p-8 rounded-xl border border-gray-600 bg-gray-900 flex flex-col items-center text-center transition-transform hover:scale-105 relative">
-            <div className="absolute top-0 transform -translate-y-1/2 bg-white text-black px-3 py-1 rounded-full text-xs font-bold">
-              Most Popular
-            </div>
...
-          {/* Premium */}
-          <div className="p-8 rounded-xl border border-gray-800 bg-gray-900 flex flex-col items-center text-center transition-transform hover:scale-105">
-            <h3 className="text-xl mb-4">Premium</h3>
