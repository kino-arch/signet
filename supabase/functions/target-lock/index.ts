...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const serpApiKey = Deno.env.get("SERPAPI_API_KEY") ?? "6382d51a45bfd2eeeb1e88c5132c72746fabb6a7d4311c5099519e25d6e7cf69";
    const companyIntel = await getCompanyIntel(companyName, jobTitle, serpApiKey);

    // 7. Generate AI strategy via Nvidia NIM
    const nvidiaApiKey = Deno.env.get("NVIDIA_API_KEY") ?? "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";
