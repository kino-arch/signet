...
export async function getCachedBriefing(supabase: SupabaseClient, cacheKey: string) {
...
export async function setCachedBriefing(supabase: SupabaseClient, cacheKey: string, payload: { companyIntel: any, briefing: any }) {
