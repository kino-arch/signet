...
export const DatacoreSchema = z.object({
  identity: z.object({
    ...
    executive_summary: z.string().describe("A high-impact, 3-sentence summary completely devoid of corporate filler words."),
  }),
  
  mission_history: z.array(
    z.object({
      company: z.string(),
      role: z.string(),
      timeline: z.object({
      ...
      metrics: z.array(z.string()).describe("Strictly quantifiable, action-oriented bullet points. Must begin with a strong verb. No markdown."),
    })
  ).describe("The user's work experience, ordered from most recent to oldest."),

  strategic_reserves: z.array(
    z.object({
