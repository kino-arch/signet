...
- Name: credit-deduction.spec.ts >> Beskar Credit Deduction >> credit balance decrements by 1 after PDF extraction (guest mode)
- Location: tests\credit-deduction.spec.ts:76:3
