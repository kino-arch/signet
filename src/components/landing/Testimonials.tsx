...
const values = [
  {
    ...
    description: "Generate highly targeted resumes that bypass Applicant Tracking Systems (ATS) and get you straight to the interview stage.",
  },
  {
    icon: Users,
    title: "Built for Professionals",
    description: "Designed by industry experts to highlight your strengths with clean, professional layouts that recruiters love.",
  },
  {
    icon: ShieldAlert,
    title: "Enterprise Standards",
    description: "Every template is tested against modern enterprise parsers to ensure your data is always read accurately.",
  },
  {
    icon: Award,
    title: "The Signet Quality",
    description: "No bloat, no distracting graphics. Pure data extracted and structured for maximum impact.",
  },
];
      ...
      <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
            We melt down your bloated work history and reforge it into streamlined, ATS-optimized assets for the modern job market.
          </p>
        </motion.div>
