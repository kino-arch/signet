  ...
  return (
    <div
      ...
      className={cn(
        ...
        'opacity-50 after:absolute after:top-1/2 after:left-1/2 after:z-[5] after:block after:size-full after:[transform:translate3d(-50%,-50%,0)] after:mix-blend-overlay after:content-[""] after:[background:radial-gradient(ellipse_at_50%_75%,var(--theme-primary)_20%,transparent_75%)]',
        className
      )}
      {...props}
    >
      ...
      <motion.div
        className={cn(
          ...
          "[background:linear-gradient(20deg,color-mix(in_srgb,var(--theme-primary)_25%,transparent)_0%,transparent_50%,color-mix(in_srgb,var(--theme-primary)_25%,transparent)_100%)_0_100%_/_100%_200%] dark:[background:linear-gradient(20deg,color-mix(in_srgb,var(--theme-primary)_25%,transparent)_0%,transparent_50%,color-mix(in_srgb,var(--theme-primary)_25%,transparent)_100%)_0_100%_/_100%_200%]"
        )}
