  ...
  return (
    <div
      ...
      className={cn(
        ...
        'after:content-[""] after:absolute after:z-[5] after:top-1/2 after:left-1/2 after:block after:size-full after:[background:radial-gradient(ellipse_at_50%_75%,#06b6d4_20%,transparent_75%)] after:[transform:translate3d(-50%,-50%,0)] after:mix-blend-overlay opacity-50',
        className,
      )}
      {...props}
    >
      ...
      <motion.div
        className={cn(
          'absolute top-[-71.5%] left-1/2 z-[3] w-[30%] h-[140%] rounded-b-full blur-3xl opacity-50 dark:mix-blend-plus-lighter mix-blend-plus-darker [transform:translate3d(-50%,0,0)] [background-position:0%_100%] [background-size:100%_200%]',
          'dark:[background:linear-gradient(20deg,#06b6d440_0%,transparent_50%,#06b6d440_100%)_0_100%_/_100%_200%] [background:linear-gradient(20deg,#06b6d440_0%,transparent_50%,#06b6d440_100%)_0_100%_/_100%_200%]',
        )}
