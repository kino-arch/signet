...
export function ProfileDropdown() {
  ...
  const tokenBalance = profile?.credits || 0
    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            className="group relative flex h-9 items-center gap-2 rounded-full border border-transparent pr-2 pl-3 transition-colors hover:border-zinc-800 hover:bg-zinc-800/50"
          >
