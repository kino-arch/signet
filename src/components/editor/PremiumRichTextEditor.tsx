  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        ...
        class: cn(
          'min-h-[120px] w-full bg-transparent px-3 py-2 text-sm focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
          '[&_p]:m-0 [&_p]:mb-2 [&_p:last-child]:mb-0',
          '[&_ul]:my-2 [&_ul]:ml-4 [&_ul]:list-disc [&_ul]:pl-2',
          '[&_ol]:my-2 [&_ol]:ml-4 [&_ol]:list-decimal [&_ol]:pl-2',
          '[&_li]:mb-1 [&_li>p]:mb-0',
          '[&.is-editor-empty:first-child::before]:text-muted-foreground [&.is-editor-empty:first-child::before]:content-[attr(data-placeholder)] [&.is-editor-empty:first-child::before]:float-left [&.is-editor-empty:first-child::before]:h-0 [&.is-editor-empty:first-child::before]:pointer-events-none'
        )
      }
    }
  });
