...
function MetricCard({ label, value, change, trend, icon }: MetricCardProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-x-0 top-0 h-0.5 rounded-t-2xl transition-opacity duration-300 group-hover:opacity-100 ${
          isPositive
  ...
  return (
    ...
    >
            ...
            <DialogContent className="max-h-[85vh] w-full max-w-5xl overflow-x-hidden overflow-y-auto border-primary/20 bg-background/95 backdrop-blur-xl sm:max-w-5xl">
              <DialogHeader>
                <DialogTitle className="sr-only">
                  Target Lock Intelligence
                </DialogTitle>
                <DialogDescription className="sr-only">
                  AI-powered company intelligence and resume strategy
                </DialogDescription>
              </DialogHeader>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        {/* Main area chart â€” Profile Views Trend (spans 2 cols) */}
        <motion.div
          variants={itemVariants}
        ...
        >
          {/* Top accent */}
          <div className="absolute inset-x-0 top-0 h-0.5 rounded-t-2xl bg-gradient-to-r from-primary/40 via-primary to-primary/40 opacity-60" />
          ...
          <div className="relative space-y-6">
            ...
            <div className="h-56 w-full" style={{ minHeight: 240 }}>
        ...
        {/* Secondary chart â€” Active Contracts */}
        <motion.div
          variants={itemVariants}
      ...
      >
        ...
        <div className="relative px-6 py-5">
          <SectionHeader
            title="System Log: ATS Scanners"
            subtitle="Recent parsing analytics"
          />
        </div>
          ...
          {[
            {
              time: "Just now",
              event:
                "System Diagnostic: 0% data loss detected. Structure integrity verified.",
              type: "update",
            },
            {
              time: "2h ago",
              event: "Workday/Taleo parsing successful. 100% parse rate.",
              type: "view",
            },
            {
              time: "5h ago",
              event:
                "Warning: 43% of two-column layouts rejected by legacy ATS systems today.",
              type: "contract",
            },
            {
              time: "1d ago",
              event:
                "Upgrade Prompt: Purchase Signet Pro to unlock 'Executive' templates.",
              type: "download",
            },
          ].map((item, i) => (
            <div
