...
const minimalSchema: TemplateSchema = {
  ...
  typography: {
    ...
    accentColor: 'var(--color-nordic-bg)',
  },
...
const technicalSchema: TemplateSchema = {
  ...
  typography: {
    ...
    accentColor: 'var(--color-nordic-accent)',
  },
  layout: 'two-column'
};
...
const creativeSchema: TemplateSchema = {
  ...
  typography: {
    ...
    bodyFont: 'Inter, sans-serif',
    accentColor: 'var(--color-nordic-error)',
  },
  layout: 'single-column'
};
...
<svg viewBox="0 0 320 400" style="width: 100%; height: auto;">
  ...
  <rect x="0" y="0" width="8" height="100" fill="var(--color-nordic-error)" />
  ...
  <rect x="20" y="120" width="40" height="12" fill="var(--color-nordic-error)" rx="2" />
</svg>`;
