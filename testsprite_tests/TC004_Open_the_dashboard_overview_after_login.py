...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Log in' button (interactive element index 422) to open the login page.
        # button "Log in"
        elem = page.locator("xpath=/html/body/div/div/div[4]/div/div/div[3]/div[2]/div[2]/a/button").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the email and password fields with admin@signet.app / Test@2026 and submit the form (send Enter).
