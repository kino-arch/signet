...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://localhost:5173/login to reach the login/signup form.
        ...
        # -> Fill the email field (index 889) with admin@signet.app, fill the password field (index 896) with Test@2026, then submit the form by sending Enter.
